            ...
            <div className="bg-white rounded-2xl shadow-2xl max-w-2xl w-full max-h-[90vh] overflow-y-auto">
                {quoteStep === 'FORM' && (
                    <>
                        <div className="p-6 border-b border-slate-100 flex justify-between items-center">
                            <h3 className="text-xl font-['Montserrat'] font-bold text-[#334155]">Request Quote</h3>
                        ...
                        <div className="p-6 space-y-6">
                            ...
                            <div className="bg-green-50 border border-green-100 rounded-xl p-4 flex items-start space-x-3">
                                ...
                                <div>
                                    <h4 className="font-bold text-green-800">Pre-Trade Compliance Check Passed</h4>
                            ...
                            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                                <div>
                                    <label className="block text-xs font-bold text-slate-500 uppercase mb-2">Vessel</label>
                                    <select className="w-full p-3 bg-slate-50 border border-slate-200 rounded-lg font-medium">
                                        <option>Verdaxis Pioneer (IMO 9812345)</option>
                                        <option>Green Horizon (IMO 9834567)</option>
                                    </select>
                                </div>
                                <div>
                                    <label className="block text-xs font-bold text-slate-500 uppercase mb-2">Quantity (MT)</label>
                                    <input type="number" defaultValue={500} className="w-full p-3 bg-slate-50 border border-slate-200 rounded-lg font-medium" />
                                </div>
                            </div>
                            ...
                            <div className="border border-slate-200 rounded-xl p-4">
                                <div className="flex justify-between items-start mb-2">
                                    ...
                                    <span className="text-xs bg-amber-100 text-amber-700 px-2 py-1 rounded font-bold">Optional</span>
                                </div>
                                <p className="text-sm text-slate-600 mb-3">
                                    3 crew members on <span className="font-semibold">Verdaxis Pioneer</span> lack Methanol Safety L2 certification required for this bunker operation.
                                </p>
                                <div className="flex items-center p-3 bg-slate-50 rounded-lg border border-slate-200">
                                    ...
                                    <div className="flex-1">
                                        <div className="text-sm font-bold text-[#334155]">{COURSES[0].title}</div>
                                        <div className="text-xs text-slate-500">{COURSES[0].duration} • Online Module</div>
                                    </div>
                        ...
                        <div className="p-6 bg-slate-50 border-t border-slate-100 flex justify-end space-x-3 rounded-b-2xl">
                            ...
                            <button 
                                ...
                                className="px-6 py-2.5 bg-[#334155] hover:bg-slate-800 text-white font-bold rounded-lg shadow-lg flex items-center space-x-2"
                            >
                ...
                {quoteStep === 'CONFIRMING' && (
                    <div className="p-12 flex flex-col items-center justify-center text-center min-h-[400px]">
                        ...
                        <h3 className="text-xl font-bold text-[#334155]">Securing Connection...</h3>
                        <p className="text-slate-500 mt-2">Encryption handshake with supplier node.</p>
                    </div>
                )}
                ...
                {quoteStep === 'SUCCESS' && (
                    <div className="p-12 flex flex-col items-center justify-center text-center min-h-[400px]">
                        ...
                        <h3 className="text-2xl font-['Montserrat'] font-bold text-[#334155] mb-2">Request Sent!</h3>
