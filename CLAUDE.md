...
- **UCOME B100 is a Marketplace product at `/app/marketplace?product=UCOME_B100`.** This active wholesale Singapore pilot has versioned contract requirements and supplier-declared quotes, expiry and revisions. It does not execute trades or reserve inventory. Existing alcohol products continue to use orderbook/listing flows.
