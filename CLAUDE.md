...
- **UCOME B100 is a Marketplace product at `/app/marketplace?product=UCOME_B100`.** This active wholesale Singapore product uses the shared Post Supply dialog and Marketplace Listings/My Listings views for indicative supplier offers, plus targeted or general RFQs. Fuel-specific declarations include standard/grade, batch quality and separate sustainability evidence. It does not execute trades or reserve inventory. Existing alcohol products continue to use executable orderbook/listing flows.
