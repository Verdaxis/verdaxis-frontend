...
import { ACTIVE_MARKETPLACE_PRODUCT_OPTIONS, getMarketplaceFuelType } from '../../utils/marketProducts';
...
export const CreateListingModal: React.FC<CreateListingModalProps> = ({
    ...
    const marketEntry = marketData.find(
        (d) => d.region === formData.region && (
            d.fuel_type === formData.fuel_type
            || d.fuel_type === getMarketplaceFuelType(formData.fuel_type)
        )
    );
