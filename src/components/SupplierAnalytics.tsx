    ...
    const header = (
        <div className="mb-6 lg:mb-8">
            ...
            <p className="text-slate-500 dark:text-slate-400 mt-1 lg:mt-2 text-sm lg:text-base">
                Business intelligence on revenue, fuel mix, regional performance, and order conversion.
            </p>
        </div>
    );
        ...
        return (
            <div className="max-w-7xl mx-auto p-4 lg:p-10 pb-24 dark:bg-slate-900 min-h-full">
                ...
                <div className="flex items-center justify-center py-24">
                    ...
                    <span className="ml-3 text-slate-500 dark:text-slate-400">Loading analytics...</span>
                </div>
            </div>
        );
    }
        ...
        return (
            <div className="max-w-7xl mx-auto p-4 lg:p-10 pb-24 dark:bg-slate-900 min-h-full">
                ...
                <div className="bg-white dark:bg-slate-800 rounded-xl shadow-sm border border-slate-200 dark:border-slate-700 p-12 text-center transition-colors">
                    ...
                    <h2 className="text-lg font-bold text-[#334155] dark:text-white mb-2">Unable to load analytics</h2>
                    <p className="text-slate-500 dark:text-slate-400 text-sm max-w-md mx-auto">
                        Something went wrong while loading your revenue data. Please try again later.
                    </p>
        ...
        return (
            <div className="max-w-7xl mx-auto p-4 lg:p-10 pb-24 dark:bg-slate-900 min-h-full">
                ...
                <div className="bg-white dark:bg-slate-800 rounded-xl shadow-sm border border-slate-200 dark:border-slate-700 p-12 text-center transition-colors">
                    ...
                    <h2 className="text-lg font-bold text-[#334155] dark:text-white mb-2">No analytics data yet</h2>
                    <p className="text-slate-500 dark:text-slate-400 text-sm max-w-md mx-auto">
                        Revenue analytics will appear here once orders start flowing through the platform.
                        Publish inventory, attract buyers, and track your performance.
                    </p>
                </div>
            </div>
        );
    ...
    return (
        <div className="max-w-7xl mx-auto p-4 lg:p-10 pb-24 dark:bg-slate-900 min-h-full">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 lg:gap-6 mb-8">
                ...
                <div className="bg-white dark:bg-slate-800 p-6 rounded-xl shadow-sm border border-slate-200 dark:border-slate-700 transition-colors">
                    <div className="flex items-center justify-between mb-3">
                        <span className="text-xs font-bold text-slate-400 uppercase tracking-wider">Volume Sold</span>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 lg:gap-6">
                ...
                <div className="bg-white dark:bg-slate-800 rounded-xl shadow-sm border border-slate-200 dark:border-slate-700 p-6 transition-colors">
                    <h3 className="font-bold text-[#334155] dark:text-white mb-1">Revenue Over Time</h3>
                    <p className="text-xs text-slate-500 dark:text-slate-400 mb-4">Monthly revenue from completed orders</p>
                ...
                {/* Revenue by Fuel Type */}
                <div className="bg-white dark:bg-slate-800 rounded-xl shadow-sm border border-slate-200 dark:border-slate-700 p-6 transition-colors">
                    <h3 className="font-bold text-[#334155] dark:text-white mb-1">Revenue by Fuel Type</h3>
                    <p className="text-xs text-slate-500 dark:text-slate-400 mb-4">Breakdown of completed order revenue</p>
                        ...
                        <ResponsiveContainer width="100%" height={260}>
                            <BarChart data={revenueByFuel} layout="horizontal">
                                ...
                                <Bar dataKey="revenue" radius={[6, 6, 0, 0]} maxBarSize={50}>
                                    {revenueByFuel.map((entry, idx) => (
                                        <Cell key={`fuel-${idx}`} fill={entry.fill} />
                                    ))}
                                </Bar>
                            </BarChart>
                        </ResponsiveContainer>
                ...
                {/* Volume by Region */}
                <div className="bg-white dark:bg-slate-800 rounded-xl shadow-sm border border-slate-200 dark:border-slate-700 p-6 transition-colors">
                    <h3 className="font-bold text-[#334155] dark:text-white mb-1">Volume by Region</h3>
                    <p className="text-xs text-slate-500 dark:text-slate-400 mb-4">Total quantity sold per region (MT)</p>
                    {volumeByRegion.length === 0 ? (
                        ...
                        <ResponsiveContainer width="100%" height={260}>
                            <BarChart data={volumeByRegion} layout="vertical">
                                ...
                                <RechartsTooltip
                                    contentStyle={darkTooltipStyle}
                                    formatter={(value: number) => [`${value.toLocaleString()} MT`, 'Volume']}
                                    labelStyle={{ color: '#94a3b8', fontWeight: 600 }}
                                />
                ...
                {/* Order Status Breakdown */}
                <div className="bg-white dark:bg-slate-800 rounded-xl shadow-sm border border-slate-200 dark:border-slate-700 p-6 transition-colors">
                    <h3 className="font-bold text-[#334155] dark:text-white mb-1">Order Status Breakdown</h3>
                    <p className="text-xs text-slate-500 dark:text-slate-400 mb-4">Distribution of all incoming orders</p>
