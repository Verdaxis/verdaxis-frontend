...
const buyerSteps: TutorialStepDefinition[] = [
    ...
    { target: '[data-tour="forward-trade-tape"]', titleKey: 'buyer.20.title', contentKey: 'buyer.20.content', placement: 'left' },
...
const supplierSteps: TutorialStepDefinition[] = [
    ...
    { target: '[data-tour="forward-trade-tape"]', titleKey: 'supplier.21.title', contentKey: 'supplier.21.content', placement: 'left' },
