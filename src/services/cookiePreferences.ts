...
export const readCookiePreferences = (
  ...
  try {
    ...
    // Preserve choices from both releases without asking existing users again.
    if ((value.version !== 1 && value.version !== 2) || typeof value.optionalAnalytics !== 'boolean') return null;
