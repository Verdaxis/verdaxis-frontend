...
export const fuelPrices: FuelPrice[] = [
  ...
  { fuel: 'VLSFO (High E)', region: 'Singapore', price: 475, change: -0.3, ci: 91.2, energyDensity: 43.3 },
  { fuel: 'VLSFO (Low E)', region: 'Singapore', price: 455, change: -0.5, ci: 92.8, energyDensity: 40.4 },
