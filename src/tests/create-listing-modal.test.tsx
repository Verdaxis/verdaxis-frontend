...
describe('CreateListingModal', () => {
  ...
  beforeEach(() => {
    ...
    deliveryPointsMock.mockResolvedValue([
      ...
      { id: 'dp-2', name: 'ARA', region: 'Europe', timezone: 'Europe/Amsterdam', is_active: true },
    ]);
  ...
  it('prefills from the latest listing template without carrying off-spec state', async () => {
    ...
    expect(screen.getByRole('combobox', { name: 'Listing delivery point' }).textContent).toContain('ARA');
